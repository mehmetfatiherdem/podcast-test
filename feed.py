# we will turn yaml file into rss which is a special type of xml because xml is way harder to write than yaml
...
for item in yaml_data['item']:
    ...
    enclosure = xml_tree.SubElement(item_element, 'enclosure', {'length': item['length'], 
